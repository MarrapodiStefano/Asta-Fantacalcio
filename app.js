...
function counts(t){let c={P:0,D:0,C:0,A:0};t.players.forEach(p=>c[p.role]++);return `<span class="countpill"><b>P</b>${c.P}</span><span class="countpill"><b>D</b>${c.D}</span><span class="countpill"><b>C</b>${c.C}</span><span class="countpill"><b>A</b>${c.A}</span>`}

...
function renderFormation(){
 ...
 pitch.className='pitch';pitch.innerHTML=pitchArtwork()+starters.map((line,i)=>'<div class="formation-line" style="top:'+positions[i]+'">'+line.map(p=>'<div class="formation-player"><div class="formation-shirt">'+p.role+'</div><div>'+esc(p.name)+'</div><small>'+p.price+'</small></div>').join('')+'</div>').join('');
